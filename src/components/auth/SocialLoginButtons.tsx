...
export function SocialLoginButtons({
  ...
  const handleGoogleLogin = () => {
    setLoading('google');
    window.location.href = `/api/auth/google?type=${userType}&returnUrl=${encodeURIComponent(returnUrl)}`;
  };

  const handleLinkedInLogin = () => {
    setLoading('linkedin');
    window.location.href = `/api/auth/linkedin?type=${userType}&returnUrl=${encodeURIComponent(returnUrl)}`;
  };
